...
image_path = "/mnt/coco/raw-data/test2017/000000000016.jpg"  # 181,
img = Image.open(image_path)
img = img.resize(size=(IMAGE_H, IMAGE_W))
img_resized = np.array(img, dtype=np.float32)
